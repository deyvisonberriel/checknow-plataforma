...
class EmailService {
   ...
   */
  generateHtmlTemplate({ customerName, courseName, material_url, certificate_url }) {
    return `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <style>
    ...
    .btn { display: inline-block; background-color: #3B8E39; color: #FFFFFF !important; text-decoration: none; padding: 14px 24px; border-radius: 10px; font-weight: 700; font-size: 14px; text-align: center; width: calc(100% - 48px); max-width: 300px; margin: 12px auto 0; box-shadow: 0 4px 6px -1px rgba(59,142,57,0.3); }
    .btn-secondary { display: inline-block; background-color: #13899C; color: #FFFFFF !important; text-decoration: none; padding: 14px 24px; border-radius: 10px; font-weight: 700; font-size: 14px; text-align: center; width: calc(100% - 48px); max-width: 300px; margin: 12px auto 0; box-shadow: 0 4px 6px -1px rgba(19,137,156,0.3); }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Obrigado por escolher a <strong>Check Now SST</strong>. É ótimo ter você conosco.</p>
      ...
      ${material_url ? `<a href="${material_url}" style="display: inline-block; padding: 12px 24px; background-color: #2F855A; color: #ffffff; text-decoration: none; border-radius: 6px; margin-top: 15px; font-weight: bold; width: 100%; text-align: center; box-sizing: border-box;">BAIXAR APOSTILA (PDF)</a>` : `<p style="color:red; font-size: 12px;">Link da Apostila indisponível.</p>`}
      <br>
      ${certificate_url ? `<a href="${certificate_url}" style="display: inline-block; padding: 12px 24px; background-color: #13899C; color: #ffffff; text-decoration: none; border-radius: 6px; margin-top: 15px; font-weight: bold; width: 100%; text-align: center; box-sizing: border-box;">BAIXAR CERTIFICADO</a>` : `<p style="color:red; font-size: 12px;">Link do Certificado indisponível.</p>`}
    </div>
